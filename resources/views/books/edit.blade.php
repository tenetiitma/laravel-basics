            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                        ...
                        @endforeach
                        <div class="mt-6">
                            <form method="POST" action="{{ route('book.attach.author', $book) }}" class="flex flex-col gap-3">
                                @csrf
                                @method('post') <!-- Kas see peab olema siin, kui ma täpselt ei tea väärtust? -->

                                <x-input-label value="Add Author:" for="author_id" />
                                <select id="author_id" name="author_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
